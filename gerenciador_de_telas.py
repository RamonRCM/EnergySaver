...
def chama_mostrar_consumo():
    tela_mostrar_consumo.pack()
    tela_inicial.pack_forget()

def chama_tela_inicial_registro_consumo():
    tela_inicial.pack()
    tela_registra_consumo.pack_forget()

def chama_tela_inicial_mostrar_consumo():
    tela_inicial.pack()
    tela_mostrar_consumo.pack_forget()
...
botao_voltar_inicio = customtkinter.CTkButton(master=tela_registra_consumo,text="Voltar",command=chama_tela_inicial_registro_consumo)
botao_voltar_inicio.place(x=1,y=450)

botao_voltar_inicio = customtkinter.CTkButton(master=tela_mostrar_consumo,text="Voltar",command=chama_tela_inicial_mostrar_consumo)
botao_voltar_inicio.place(x=1,y=450)